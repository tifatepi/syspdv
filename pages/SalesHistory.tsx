...
const SalesHistory: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 overflow-y-auto h-full custom-scrollbar">
      {/* Área da Interface (Oculta na Impressão) */}
      ...
      {selectedSale && (
        <>
          {/* Modal de Visualização (Oculto na Impressão) */}
          <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-slate-900/90 backdrop-blur-sm no-print">
          ...
          {/* Área de Impressão (Visível apenas no Driver de Impressão) */}
